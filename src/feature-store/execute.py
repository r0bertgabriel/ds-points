...
ORIGIN_ENGINE = sqlalchemy.create_engine("sqlite:///../../dados/data/database.db")
TARGET_ENGINE = sqlalchemy.create_engine("sqlite:///../../dados/data/feature_store.db")

# Import da query
query = import_query(f"{args.feature_store}")
